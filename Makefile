...
GO_LINKER_FLAGS ?= -ldflags \
				   "-X github.com/demisto/mattermost-server/model.BuildNumber=$(BUILD_NUMBER)\
				    -X 'github.com/demisto/mattermost-server/model.BuildDate=$(BUILD_DATE)'\
				    -X github.com/demisto/mattermost-server/model.BuildHash=$(BUILD_HASH)\
				    -X github.com/demisto/mattermost-server/model.BuildHashEnterprise=$(BUILD_HASH_ENTERPRISE)\
				    -X github.com/demisto/mattermost-server/model.BuildEnterpriseReady=$(BUILD_ENTERPRISE_READY)"
